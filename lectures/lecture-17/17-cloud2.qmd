...
3. Update, upgrade, and install Python 3, pip, and Jupyter:
    ...
    - The package is [`jupyter-notebook`]{.alert}, with a hyphen, and it pulls the library in with it. `python3-notebook` installs the library and an older notebook version, so `jupyter-notebook` is the reliable name for the command and the server
